...
class Product(db.Model):    
    ...
    - Un atributo category en la clase Product que te permite acceder a la categoría a la que pertenece un producto.
    - Un atributo products en la clase Category, que es una relación. Este atributo devuelve una consulta 
